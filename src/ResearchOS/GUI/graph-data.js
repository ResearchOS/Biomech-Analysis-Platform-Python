const graphData = {
    ...
    edges: [
        ...
        },
        {
                "id": "Static_Cal_Trial_Name VR65",
                "from": "LG1",
                "to": "anatomic_axes PR13"
        },
        {
                "id": "Motive_Initial_Frame VR13",
                "from": "LG1",
                "to": "start_end_frames PR16"
        },
        {
        ...
        },
        {
                "id": "Static_Cal_Trial_Name VR65",
                "from": "LG1",
                "to": "normalize_wbam_vistamehr PR26"
        },
        {
                "id": "Trial_Type_Task VR8",
                "from": "LG1",
                "to": "pelv_heading_angle_plotting PR34"
        },
        {
                "id": "Trial_Type_Task VR8",
                "from": "LG1",
        ...
        },
        {
                "id": "mocap_frame_rate VR34",
                "from": "importer PR1",
                "to": "Derivative of Segment COM Position PR20"
        },
        {
                "id": "mocap_frame_rate VR34",
                "from": "importer PR1",
                "to": "Segment Angular Velocity PR22"
        },
        {
                "id": "mocap_frame_rate VR34",
                "from": "importer PR1",
        ...
        },
        {
                ...
                "to": "static_cal_rigid_bodies_dumas2007 PR11"
        },
        {
                "id": "card_mocap_data VR33",
                "from": "static_hjc PR10",
        ...
        {
                "id": "static_anat_axes VR59",
                "from": "static_cal_rigid_bodies_dumas2007 PR11",
                "to": "foot_virtual_markers_to_dynamic PR12"
        },
        {
                "id": "static_cal_idx VR60",
                "from": "static_cal_rigid_bodies_dumas2007 PR11",
                "to": "foot_virtual_markers_to_dynamic PR12"
        },
        {
        ...
        {
                "id": "card_mocap_data VR33",
                "from": "foot_virtual_markers_to_dynamic PR12",
                "to": "seg_com_pos PR17"
        },
        {
                "id": "card_mocap_data VR33",
                "from": "foot_virtual_markers_to_dynamic PR12",
                "to": "zeni_gait_events PR33"
        },
        {
                "id": "anat_axes VR62",
                "from": "anatomic_axes PR13",
                "to": "foot_virtual_markers_to_dynamic PR12"
        },
        {
                "id": "anat_axes VR62",
        ...
        },
        {
                "id": "anat_axes VR62",
                "from": "anatomic_axes PR13",
                "to": "bodyfixed_ax_pelvis PR27"
        },
        {
                "id": "card_mocap_data VR33",
                "from": "smooth_mocap PR14",
                "to": "static_hjc PR10"
        },
        {
                "id": "card_mocap_data VR33",
        ...
        },
        {
                "id": "Motive_Initial_Frame VR13",
                "from": "start_end_frames PR16",
                "to": "pelvis_heading_angle_thresh PR38"
        },
        {
                "id": "Motive_Final_Frame VR14",
                "from": "start_end_frames PR16",
        ...
        },
        {
                "id": "seg_com_position VR55",
                "from": "seg_com_pos PR17",
                "to": "seg_com_to_tbcm_pos_vector PR23"
        },
        {
                "id": "seg_com_position VR55",
                "from": "seg_com_pos PR17",
        ...
        },
        {
                ...
                "to": "seg_com_to_tbcm_veloc_vector PR24"
        },
        {
                "id": "tbcm_velocity VR68",
                "from": "Derivative of TBCM Position PR19",
                "to": "gait_speed_3d PR39"
        },
        {
                "id": "tbcm_velocity VR68",
                "from": "Derivative of TBCM Position PR19",
                "to": "gait_speed_horz PR40"
        },
        {
                "id": "tbcm_velocity VR68",
                "from": "Derivative of TBCM Position PR19",
        ...
        {
                "id": "seg_com_velocity VR69",
                "from": "Derivative of Segment COM Position PR20",
                "to": "seg_com_to_tbcm_veloc_vector PR24"
        },
        {
                "id": "seg_mom_of_i_global VR70",
                "from": "mom_of_i_to_global PR21",
                "to": "wbam_global PR25"
        },
        {
                "id": "seg_ang_veloc_global VR71",
                "from": "Segment Angular Velocity PR22",
                "to": "wbam_global PR25"
        },
        {
                "id": "seg_com_to_tbcm_pos_vector VR72",
                "from": "seg_com_to_tbcm_pos_vector PR23",
                "to": "wbam_global PR25"
        },
        {
                "id": "seg_rel_veloc_to_tbcm VR73",
                "from": "seg_com_to_tbcm_veloc_vector PR24",
                "to": "wbam_global PR25"
        },
        {
                "id": "wbam_global VR74",
        ...
        {
                "id": "subject_height VR40",
                "from": "comp_height PR3",
                "to": "normalize_wbam_vistamehr PR26"
        },
        {
        ...
        {
                "id": "pelvis_heading_angle_plotting VR86",
                "from": "pelv_heading_angle_plotting PR34",
                "to": "phase_of_interest PR36"
        },
        {
                "id": "pelvis_heading_angle VR84",
                "from": "pelv_heading_angle PR35",
                "to": "pelvis_heading_angle_thresh PR38"
        },
        {
        ...
        },
        {
                ...
                "from": "pass_column_idx PR37",
                "to": "phase_of_interest PR36"
        },
        {
                "id": "tbcm_pass_second_col_idx VR90",
                "from": "pass_column_idx PR37",
                "to": "phase_of_interest PR36"
        },
        {
                "id": "pelvis_heading_angle_thresh VR87",
                "from": "pelvis_heading_angle_thresh PR38",
                "to": "phase_of_interest PR36"
        },
        {
        ...
        {
                "id": "best_marker_names VR49",
                "from": "best_marker_names PR9",
                "to": "foot_virtual_markers_to_dynamic PR12"
        },
        {
                "id": "best_marker_names VR49",
