# Code from: https://doc.qt.io/qtforpython-6/examples/example_widgets_layouts_dynamiclayouts.html
# Copyright (C) 2013 Riverbank Computing Limited.
# Copyright (C) 2022 The Qt Company Ltd.
# SPDX-License-Identifier: LicenseRef-Qt-Commercial OR BSD-3-Clause

"""PySide6 Put of the widgets/layouts/dynamiclayouts example from Qt v5.x"""
...
class Dialog(QDialog):
    ...
    def create_rotable_group_box(self):
        self._rotable_group_box = QGroupBox("Rotable Widgets") # Create a group box

        # Create each of the rotable widgets.  
        ...
        count = len(self._rotable_widgets) # Get the number of rotable widgets.
        print('test')
