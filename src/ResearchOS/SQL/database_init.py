...
class DBInitializer():
    ...
    def init_values(self):
        ...
        self.init_attr(name = "timestamp_opened")
        self.init_attr(name = "timestamp_closed")
        ...
        self.init_attr(name = "current_specify_trial_id")
        self.init_attr(name = "current_view_id")
        self.init_attr(name = "current_user_id")
