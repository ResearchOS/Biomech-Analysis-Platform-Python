...
class LoginWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None, ui_filename=None, db_filename=None):
        super().__init__()        
        self.parent = parent
    ...
    def setLoginWindowSignals(self, ui, db_filename=None):
        ui.signinButton.clicked.connect(lambda: handleLogin(ui.usernameEdit.text(), ui.passwordEdit.text(), db_filename))
...
if __name__ == '__main__':
    ...
    LoginWindow(app, ui_filename, db_filename) # The app is the parent of the loginWindow    
    sys.exit(app.exec())